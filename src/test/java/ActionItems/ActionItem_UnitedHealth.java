...
public class ActionItem_UnitedHealth {
    ...
    @Test()
    public void tc001_findADentist() throws InterruptedException {
    ...
    @Test(dependsOnMethods = "tc001_findADentist")
    ...
    @Test(dependsOnMethods = "tc002_zipCode")
    public void tc003_menu() {
    ...
    @Test(dependsOnMethods = "tc003_menu")
    public void tc004_nearbyDoctor() throws InterruptedException {
