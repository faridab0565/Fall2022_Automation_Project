...
public class Reusable_Actions_Loggers {
    ...
    public static void submitAction(WebDriver driver, String xpath, ExtentTest logger, String elementName) {
        ...
        try {
            ...
            logger.log(LogStatus.FAIL, "Unable submit " + elementName + "for reason " + e);
        }
    ...
    public static void mouseHover(WebDriver driver, String xpath, ExtentTest logger, String elementName) {
        ...
        try {
            ...
            logger.log(LogStatus.PASS, "Successfully hovered mouse to " + elementName);
        } catch (Exception e) {
            System.out.println("Unable to hover to element: " + elementName + " for reason: " + e);
            logger.log(LogStatus.FAIL, "Unable to hover mouse to  " + elementName);
        }
    ...
    public static void clearText(WebDriver driver, String xpath, ExtentTest logger, String elementName) {
        WebDriverWait wait = new WebDriverWait(driver, timeout);
        try {
            WebElement element = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpath)));
            element.clear();
            logger.log(LogStatus.PASS, "Successfully clear " + elementName);
        } catch (Exception e) {
            System.out.println("Unable to clear element: " + elementName + " for reason: " + e);
            logger.log(LogStatus.FAIL, "Unable to clear " + elementName + "for reason " + e);
        }//end of catch
    }//end of clear  action

    public static void clearTextByIndex(WebDriver driver, String xpath, int index, ExtentTest logger, String elementName) {
        WebDriverWait wait = new WebDriverWait(driver, timeout);
        try {
            wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath(xpath))).get(index).clear();
            logger.log(LogStatus.PASS, "Successfully clear by index " + elementName);
        } catch (Exception e) {
            System.out.println("Unable to click on element: " + elementName + " for reason: " + e);
            logger.log(LogStatus.FAIL, "Unable to clear by index " + elementName + "for reason " + e);
        }//end of catch
